...
cur.execute("insert into contact values(%s,%s,%s,%s,%s)",(first_name,last_name,email,mobile_no,symptoms))
con.commit()
cur.close()
con.close()
...
print('<h3 class="card-text text-primary ml-5"> thank you for contact us our doctors team will contact you as soon as possible</h3>')
print('<h6 class="card-text ml-5 ">please protect yourself and your family untill we contact you</h6>')
print('<p class="card-text ml-5 ">stay safe and healthy</p>')

print('<button href="home.html" class="card-link ml-5  btn-primary">home</button>')
print('<button href="prevention.html" class="card-link ml-5  btn-primary">protect yourself</button>')
print('</div>')
print('</div>')
print('</div>')
print('</div>')
